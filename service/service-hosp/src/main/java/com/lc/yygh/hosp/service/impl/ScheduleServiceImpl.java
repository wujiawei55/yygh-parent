...
import com.lc.yygh.hosp.repository.ScheduleRepository;
...
import com.lc.yygh.vo.hosp.BookingScheduleRuleVo;
...
//        String hosScheduleId = (String) paramMap.get("hosScheduleId");
        //根据医院编号和排班编号查询排班
        Schedule scheduleExist = scheduleRepository.findByHoscodeAndHosScheduleId(schedule.getHoscode(),
...
//1 根据医院编号 和 科室编号 查询
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        List<Schedule> schedules = scheduleRepository.findByHoscodeAndDepcodeAndWorkDate(hoscode, depcode, new DateTime(workDate).toDate());
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        //调用mongoTemplate对象的方法操作mongoDB数据库中的Schedule集合
        Map<String,Object> result = new HashMap<>();
        //获取预约规则
        //根据医院编号获取预约规则
